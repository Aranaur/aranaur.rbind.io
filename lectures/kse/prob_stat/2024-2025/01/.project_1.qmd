...
::: {.callout-note}
- Every team **up to 3 students**.
- Every team member uploads submission file to the Moodle.
:::
...
- Identify the statistical test you will use to answer your research question.
- Describe why you chose this test.
- State the null and alternative hypotheses.
- Describe the assumptions of the test.
- Describe how you will conduct the test.
...
Submit your project as a single PDF/DOCX file. The file should contain the following:

1. Title page with the title of the project, your name, and the date.
2. Table of contents.
3. Introduction and data for each data set.
4. Research question for each data set.
5. Data cleaning for each data set.
6. Statistical data visualization for each data set.
7. Statistical tests for each data set.
8. Conclusion for each data set.

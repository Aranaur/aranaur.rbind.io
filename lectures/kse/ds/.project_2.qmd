...
To prepare for this conversation: identify a data set and a research question for the final project. This can be one of the datasets you used in your first project, but if you find it difficult to ask him statistical questions, it is better to think about an alternative. If you’re unsure where to find data, you can use the list of potential data sources in the [Resources for datasets](https://aranaur.quarto.pub/project-1/#resources-for-datasets) section as a starting point. It may also help to think of topics you’re interested in investigating and find data sets on those topics.
...
Your report must be written using Quarto. Your written report should not exceed five pages inclusive of all tables and figures.
...
Your presentation must be no longer than 7 minutes. Final presentations will be held at the last class meeting (20.12.2024). You will present your project to the class and answer questions from your peers and the instructor.
...
We recommend choosing an option that’s easy to collaborate with, e.g., Google Slides or Quarto with Posit Cloud ([Share & Collaborate in Spaces](https://docs.posit.co/cloud/guide/collaborate/)).

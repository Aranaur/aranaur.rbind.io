...
4. **commit to a prediction**: which simple method will be hardest to beat, on what evidence.

Next week you run them and find out. The prediction is marked on the reasoning, not on
being right.
